      ...
      <div class="container">
          <div class="row">
            ...
            <div class="col-sm-10" style="background-color: #fff; padding: 50px; border-radius: 20px ">
                <center><p style="margin-top: -15px; font-size:35px"> ADD ENTRY </p></center><br>
                ...
                <form action="addcode.php" method="POST">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label for="p_Date">Purchase Date</label><br>
                        ...
                        <div class="col-sm-5">
                           <div class="input-group">
                            ...
                            <input class="form-control" id="date" name="p_date" placeholder="YYYY/MM/DD" type="text" required/>
                           </div>
                          </div>
                      </div><br>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-5">
                           <div class="input-group">
                            ...
                            <input class="form-control" id="date" name="b_date" placeholder="YYYY/MM/DD" type="text"/ >
                           </div>
                          </div>
                      </div><br>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-5">
                           <div class="input-group">
                            ...
                            <input class="form-control" id="date" name="pay_date" placeholder="YYYY/MM/DD" type="text"/ >
                           </div>
                          </div>
                      </div><br>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="supp_name" class="form-control" placeholder="Supplier's Name" required>

                      </div>

                      <div class="form-group">
                        <label for="Category">Details of Asset</label>
                        <input type="text" name="details" class="form-control" placeholder="Details of Asset" >

                      </div>

                      <div class="form-group">
                        <label for="Category">Type and Make</label>
                        <input type="text" name="type" class="form-control" placeholder="Type and make" required>

                      </div>

                      <div class="form-group">
                        <label for="Category">Short Code</label>
                      ...
                      <div class="form-group">
                        <label for="Category">Page No.</label>
                        <input style="text-transform:uppercase" type="text" name="page_no" class="form-control" placeholder="Page no." >
                    ...
                    <div class="col-sm-6">
                       ...
                       <div class="form-group">
                        <label for="Category">Unit cost</label>
                      ...
                      <div class="form-group"  style="margin-top: -30px;">
                        ...
                        <label for="Category">Department</label>
                         ...
                         <div id="uni" style="display: none;">
                          ...
                          <div class="form-check form-check-inline ">
                              <input class="form-check-input" type="radio" name="department" id="inlineRadio1" value="ACCT" >
                             ACCT
                            </div>
                            <div class="form-check form-check-inline ">
                              <input class="form-check-input" type="radio" name="department" id="inlineRadio1" value="SSCSSN" >
                             SSCSSN
                            </div>
                            <div class="form-check form-check-inline ">
                            ...
                            <div class="form-check form-check-inline ">
                              <input class="form-check-input" type="radio" name="department" id="inlineRadio1" value="ANCHOR" >
                             ANCHOR
                            </div>
                            <div class="form-check form-check-inline ">
                            ...
                            <div class="form-check form-check-inline ">
                              <input class="form-check-input" type="radio" name="department" id="inlineRadio1" value="SPORTS" >
                             SPORTS
                            </div>
                            <div class="form-check form-check-inline ">
                              <input class="form-check-input" type="radio" name="department" id="inlineRadio1" value="COE" >
                             COE
                            </div>
                            <div class="form-check form-check-inline ">
                              <input class="form-check-input" type="radio" name="department" id="inlineRadio1" value="ADMIN" >
                             ADMIN
                            </div>
                            <div class="form-check form-check-inline ">
                              <input class="form-check-input" type="radio" name="department" id="inlineRadio1" value="CE" >
