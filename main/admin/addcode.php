<?php 
  ...
  if(((strcmp($p_date,$b_date) > 0) && $b_date != '') OR ((strcmp($b_date,$pay_date) > 0) && $pay_date != '')){
      ...
      <div class="container">
          <div class="row">
            	...
            	<div class="col-sm-8" style="background-color: #fff; padding: 50px; border-radius: 20px ">
                	<center><p style="margin-top: -15px; font-size:50px">|| Data Added Successfully!!! ||</p></center>

                  <center><p style="margin-top: -15px; font-size:50px">|| Your Barcode(s) ||</p></center>
